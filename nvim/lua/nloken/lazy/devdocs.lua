return {
    ...
    opts = {
        ...
        ensure_installed = { "rust", "cpp", "c", "go" }, -- get automatically installed
    ...
    config = function(_, opts)
        ...
        vim.keymap.set("n", "<leader>dd", "<cmd>DevdocsOpenCurrent<cr>", {
            desc = "Open DevDocs for current filetype",
        })

        vim.keymap.set("n", "<leader>dD", "<cmd>DevdocsOpenCurrentFloat<cr>", {
            desc = "Open DevDocs for current filetype in float",
        })
    end,
}
