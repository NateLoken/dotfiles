...
hl.on("hyprland.start", function()
    hl.exec_cmd("dbus-update-activation-environment WAYLAND_DISPLAY DISPLAY XDG_CURRENT_DESKTOP XDG_SESSION_DESKTOP XDG_SESSION_TYPE XDG_RUNTIME_DIR")
...
hl.bind(mainMod .. " + P",          hl.dsp.exec_cmd("~/.local/bin/shot-area"))
hl.bind(mainMod .. " + SHIFT + P",  hl.dsp.exec_cmd("~/.local/bin/shot-window"))
hl.bind(mainMod .. " + CTRL + P",   hl.dsp.exec_cmd("~/.local/bin/shot-full"))
